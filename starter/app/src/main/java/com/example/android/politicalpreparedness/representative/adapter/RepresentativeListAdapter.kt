...
/**
 * RecyclerView Adapter for setting up data binding on the item in the [Representative] list.
 */
...
class RepresentativeViewHolder(val binding: RepresentativeItemBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(item: Representative) {
        ...
        binding.representativeImageView.setImageResource(R.drawable.ic_profile)
...
//COMPLETE: Show social links ** Hint: Use provided helper methods
//COMPLETE: Show www link ** Hint: Use provided helper methods
//COMPLETE: Add companion object to inflate ViewHolder (from)
//COMPLETE: Create RepresentativeDiffCallback
//COMPLETE: Create RepresentativeListener